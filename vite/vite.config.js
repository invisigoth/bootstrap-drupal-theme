...
// Pull config from iconagency.libraries.yml
const yml = YAML.parse(fs.readFileSync('./iconagency.libraries.yml', 'utf8'))
...
export default ({ mode }) => {
  ...
  return defineConfig({
    ...
    base: mode === 'development' ? '/' : `/themes/custom/iconagency/${outDir}/`,
